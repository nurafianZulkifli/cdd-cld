...
class TransitDisplay {
    ...
    toggleDoors() {
        ...
        window.pageController.setActiveMedia({
            ...
            audio: 'announcements-nsl/dc-ann.wav',
            cddLoop: false,
            cldLoop: false
        });
        ...
        window.pageController.playAudio('announcements-nsl/dc-ann.wav');
...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        const lineDataResponse = await fetch('assets/data/line-data-nsl.json');
